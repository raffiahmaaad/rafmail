...
const SYSTEM_DOMAINS = ["rafxyz.web.id"];
...
export function SettingsDialog({
  ...
  const [activeTab, setActiveTab] = useState<"domains" | "retention">(
    "retention"
  );
                    ...
                    <div className="space-y-6">
                      <div className="bg-gradient-to-br from-purple-500/10 to-blue-500/10 rounded-xl p-5 border border-white/5">
                        ...
                        <p className="text-xs text-gray-400 leading-relaxed">
                          ...
                          Setting a shorter duration improves privacy, while a
                          longer duration ensures you don't miss important
                          mails.
                        </p>
                      </div>
                        ...
                        <div className="grid grid-cols-1 gap-2">
                          {RETENTION_OPTIONS.map((opt) => (
                            ...
                            >
                              ...
                              {retention === opt.value && (
                                <span className="text-[10px] font-bold px-2 py-1 rounded bg-purple-500/20 text-purple-300">
                                  ACTIVE
                                </span>
                              )}
                            </button>
